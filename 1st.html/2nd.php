<div class="content">
        <div class="info">
            <h1>Information</h1>
            <p>First Name: <?php echo $_get['customerName']; ?> </p><br>
            <p>Middle Name: <?php echo $_get['gender']; ?> </p><br>
            <p>Last Name: <?php echo $_get['age']; ?> </p><br>
            <p>Birthday: <?php echo $_get['address']; ?> </p><br>
            <p>cinema: <?php echo $_get['cinema']; ?></p>
            <p>numTickets: <?php echo $_get['numTickets']; ?></p>
